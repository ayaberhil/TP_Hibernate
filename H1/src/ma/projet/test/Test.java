...
public class Test {
    ...
    public static void main(String[] args){
            ...
            ps.create(new Produit("NIKE","R1",new Date(),123,"sneakers"));
            ps.create(new Produit("ADIDAS","R2",new Date(),231,"shirt"));
            ps.create(new Produit("CARTIER","R3",new Date(),321,"watch"));
            ps.create(new Produit("SEPHORA","R4",new Date(),7,"serum"));
            ps.create(new Produit("GUCCI","R5",new Date(),44,"jacket"));  
